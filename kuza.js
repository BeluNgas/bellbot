...
let botname = '*_｢ Bell BoTz ｣ 冬_*' //NAMA BOT
let lolkey = 'isi'
...
let ownername = '*_｢ BelluNgas ✘ ｣_*' //NAMA OWNER
let owner = '601136151330' // NOMOR OWNER
let symbol = '*☛*'
let faketeks = `*_｢ Bell BoTz ｣ 冬_*` 
...
const katalog = (teks) => {
res = kuza.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "Bell BoTz😈", "thumbnail": fs.readFileSync('pee.jpg'), "surface": 'CATALOG' }}, {quoted:fstatus})
kuza.relayWAMessage(res)}
const fakeyt = (teks) => { 
kuza.sendMessage(from, teks, text,{contextInfo :{text: 'hi', "forwardingScore": 1000000000, isForwarded: false, sendEphemeral: false, "externalAdReply": { "title": `hallo ${pushname}🗿` , "body": `YT : BelluNgas`, "mediaType": "2", "thumbnailUrl": "https://c.top4top.io/p_2087f30hj1.jpeg", "mediaUrl": "https://tps.com/channel/UCJPqI5eVhKPXPL2V8y6pIDA", "thumbnail": fs.readFileSync('pee.jpg'), "sourceUrl": "", },mentionedJid:[sender]}, quoted : fstatus})};
...
const fstatus = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "YT : BelluNgas", 'jpegThumbnail': fs.readFileSync('pee.jpg')}}}
...
if (isGroupAdmins) return reply('Tchh Admin Mah Bebas Yekan:v')
...
run = process.uptime();
 ...
 footerText: '🌀 𝐶𝑟𝑒𝑎𝑡𝑒𝑑 𝑏𝑦 𝐿𝑢𝑛𝑔𝑎𝑠',
 description: `Hai kak @${sender.split('@')[0]}, Saya ${botname}, bot ini masih dalam perkembangan jadi featurenya dikit sedikit,click list menu dibawah :3
...
costum(buffer, sticker, Verived, `Yt BelluNgas`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
